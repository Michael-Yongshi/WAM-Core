...
if __name__ == "__main__":
    ...
    add_magicref(
        ...
        difficulty = 7,
        description = (
            "<i>This weapon of the faithful glows with a golden light, imbued as it is with the righteous power of Sigmar.</i>"
            "<br/><br/>"
    ...
    add_magicref(
        ...
        difficulty = 8,
        description = (
            "<i>As the three words of power are spoken, waves of glory surround the servant of Sigmar. The faithful are heartened by the warrior god’s presence.</i>"
            "<br/><br/>"
            "Any allied warriors within 8 inch of the warrior become immune to Fear and All Alone tests. In addition, the whole warband gains +1 to any Rout tests they have to make. The effects of this spell last until the caster is knocked down, stunned or put out of action. If cast again the effects are not cumulative, ie, the maximum bonus to Rout tests remains +1."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 9,
        description = (
            "<i>The wrath of Sigmar comes to earth. Purifying flames surround the Priest and wipe out those who resist the righteous fury of the God-Emperor!</i>"
            "<br/><br/>"
            "All enemy models within 4 inch of the servant of Sigmar suffer a Strength 3 hit. No armour saves are allowed. The servants of darkness and Chaos are especially susceptible to Sigmar’s holy power. Undead and Possessed models in range suffer a Strength 5 hit instead."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 6,
        description = (
            "<i>A shield of pure white light appears in front of the Priest. As long as his faith remains strong the shield will protect him.</i>"
            "<br/><br/>"
    ...
    add_magicref(
        ...
        difficulty = 5,
        description = (
            "<i>Laying hands upon a wounded comrade, the servant of Sigmar calls upon his Lord to heal the warrior’s wounds.</i>"
            "<br/><br/>"
            "Any one model within 2 inch of the Priest (including himself) may be healed. The warrior is restored to his full quota of Wounds. In addition, if any friendly models within 2 inch are stunned or knocked down, they immediately come to their senses, stand up, and continue fighting as normal."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 9,
        description = (
            "<i>Impenetrable armour covers the Priest and the fiery image of a twin-tailed comet burns above his head.</i>"
            "<br/><br/>"
            "The Priest has an armour save of 2+ which replaces his normal armour save. In addition, he causes fear in his enemies and is therefore immune to fear himself. The power of the Armour of Righteousness lasts until the beginning of the Priest’s next Shooting phase."
        ),
    )
    ...
    add_magicref(
        ...
        difficulty = 10,
        description = (
            "<i>The Necromancer sucks out the very essence of life from his victim, stealing its vigour for himself.</i>"
            "<br/><br/>"
            "You may choose a single model within 6 inch. The target suffers a wound (no save allowed) and the Necromancer gains an extra wound for the duration of the battle. This may take the Necromancer’s Wounds above his original maximum value. This spell will not affect the Possessed or any Undead models."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 5,
        description = (
            "<i>At the spoken command of the Necromancer, the dead rise to fight again.</i>"
            "<br/><br/>"
            "One Zombie that went out of action during the last hand-to-hand combat or Shooting phase immediately returns to the battle. Place the model within 6 inch of the Necromancer. The model cannot be placed straight into hand-to-hand combat with an enemy model."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 6,
        description = (
            "<i>The Necromancer calls on the power of Necromancy to reveal the moment of his enemies’ death.</i>"
            "<br/><br/>"
    ...
    add_magicref(
        ...
        difficulty = 9,
        description = (
            "<i>The Necromancer whispers to the sleeping dead to rise up from the ground and seize his enemies.</i>"
            "<br/><br/>"
            "Choose one enemy model within 12 inch. The model must immediately roll equal to or less than his Strength on a D6 or the dead emerging from the earth will rend him with supernatural power. If he fails, you may roll on the Injury table to see what happens to the unfortunate warrior."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 6,
        description = (
            "<i>The Necromancer summons the world of the dead to invigorate his Undead servants.</i>"
            "<br/><br/>"
            "A single Zombie or Dire Wolf within 6 inch of the Necromancer may immediately move again up to its maximum Movement distance (ie, 9 inch in the case of Dire Wolves). If this moves them into base contact with an enemy model, they count as charging."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 0,
        description = (
            "<i>The Necromancer calls the soul of a slain Hero back to his body and enslaves him with corrupt magic.</i>"
            "<br/><br/>"
    ...
    add_magicref(
        ...
        difficulty = 10,
        description = (
            "<i>The Chaos Mage summons horrible visions of the realm of Chaos, causing his enemy to recoil in utter horror.</i>"
            "<br/><br/>"
            "This spell has a range of 6 inch and must be cast on the closest enemy model. If the Chaos Mage is in hand-to-hand combat, he must choose his target from those in base contact with him. The affected model is immediately stunned. If the model cannot be stunned it is knocked down instead."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 7,
        description = (
            "<i>The Chaos Mage implores the Dark gods to grant a boon to their servant.</i>"
            "<br/><br/>"
            "You may use the Eye of God successfully only once per battle. Choose any single model within 6 inch, friend or foe. Roll a D6 to see what happens to the affected model."
            "<br/><br/>"
            "D6     Result<br/>"
            "1      The wrath of the gods descends upon the target. The model is taken out of action immediately. He does not have to roll on the Serious Injury chart after the battle though.<br/>"
            "2-5    The model gains +1 to any one of his characteristics during this battle (chosen by the player who cast the spell).<br/>"
            "6      The model gains +1 to all of its characteristics for the duration of the battle.<br/>"
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 8,
        description = (
            "<i>The Chaos Mage cuts his palm and his blood spurts out, burning flesh and armour.</i>"
            "<br/><br/>"
            "This attack has a range of 8 inch and causes D3 S5 hits. It hits the first model in its path. After using this spell the Chaos Mage must roll on the Injury table for himself to see how dangerous the wound is, though treat the out of action result as stunned instead."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 9,
        description = (
            "<i>The Chaos Mage calls upon the taint of chaos which exists in the inner soul of all living beings.</i>"
            "<br/><br/>"
    ...
    add_magicref(
        ...
        difficulty = 7,
        description = (
            "<i>The Chaos Mage is lifted from the ground by two shadowy Daemons and carried wherever he wants to go.</i>"
            "<br/><br/>"
            "The Chaos Mage may immediately move anywhere within 12 inch, including into base contact with an enemy, in which case he counts as charging. If he engages a fleeing enemy, in the close combat phase he will score one automatic hit and then his opponent will flee again (if he survives)."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 7,
        description = (
            "<i>Speaking the forbidden name of his dark god, the Chaos Mage causes indescribable pain to all who hear it.</i>"
            "<br/><br/>"
            "All models within 3 inch of the Chaos Mage, friend or foe, suffer one S3 hit. No armour saves are allowed."
        ),
    )
    ...
    add_magicref(
        source = "Core Rules", 
        category = "Lesser Magic",
        name = "Fires of U'Zhul",
        group = "Spells",
        difficulty = 7,
        description = (
            "<i>The wizard summons a fiery ball of flames and hurls it upon his enemies.</i>"
            "<br/><br/>"
            "The fireball has a range of 18 inch and causes one Strength 4 hit. It strikes the first model in its path. Armour saves are taken as normal (ie, with -1 modifier)."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 7,
        description = (
            "<i>Calling upon the power of the winds of magic, the wizard walks on air.</i>"
            "<br/><br/>"
            "The wizard may immediately move anywhere within 12 inch, including into base contact with an enemy, in which case he counts as charging. If he engages a fleeing enemy in the close combat phase he will score 1 automatic hit and then his opponent will flee again (if he survives)."
        ),
    )
    add_magicref(
        source = "Core Rules", 
    ...
    add_magicref(
        ...
        difficulty = 7,
        description = (
            "<i>Silvery arrows appear from thin air and circle around the wizard, shooting out to strike his foes.</i>"
            "<br/><br/>"
    ...
    add_magicref(
        ...
        difficulty = 6,
        description = (
            "<i>The wizard summons the fickle power of magic to manipulate chance.</i>"
            "<br/><br/>"
    ...
    add_magicref(
        ...
        difficulty = 8,
        description = (
            "<i>A flaming sword appears in the hand of the wizard, promising red ruin to all who stand in his way.</i>"
            "<br/><br/>"
    ...
    add_magicref(
        source = "Core Rules", 
        category = "Magic of the Horned Rat",
        name = "Warpfire",
        group = "Spells",
        difficulty = 8,
        description = (
            "<i>A green flame leaps from the outstretched paw of the Sorcerer and burns its victims with indescribable agony.</i>"
            "<br/><br/>"
            "The spell has a range of 8 inch, hitting the first model in its path. The spell causes D3 Strength 4 hits on its target, and one Strength 3 hit on each model within 2 inch of the target."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 0,
        description = (
            "<i>The Sorcerer raises his paws and calls upon the Father of the Skaven to send forth his servants.</i>"
            "<br/><br/>"
            "This spell must be used before the game, and may only be used once. When cast, the spell summons D3 Giant Rats, which are placed within 6 inch of the Sorcerer. The Sorcerer may cast this spell successfully only once per battle, and the rats disappear after the battle. They do not count towards the maximum size of the Skaven warband."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 7,
        description = (
            "<i>The target is attacked by rats and soon is covered from head to foot in small, bleeding wounds.</i>"
            "<br/><br/>"
            "The Gnawdoom causes 2D6 Strength 1 hits on a single model within 8 inch of the caster."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 8,
        description = (
            "<i>With a chittering incantation the Sorcerer turns into a monstrous rat-like creature, which attacks with an insane fury.</i>"
            "<br/><br/>"
            "The Sorcerer may immediately charge any enemy model within 12 inch (ignoring any terrain and interposing models) and gains 2 extra Attacks and +1 Strength during this turn’s hand-to-hand combat phase only."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 8,
        description = (
            "<i>Gaze into the eye of the warp and despair!</i>"
            "<br/><br/>"
            "All standing models in base contact with the Sorcerer must take an immediate Leadership test. If they fail, they each suffer a Strength 3 hit and must run 2D6 inch directly away from the Sorcerer, exactly as if they had lost their nerve when fighting against more than one opponent."
        ),
    )
    add_magicref(
        source = "Core Rules", 
        ...
        difficulty = 6,
        description = (
            "<i>The Sorcerer points a claw towards one of his enemies and curses him in the name of the Horned One.</i>"
            "<br/><br/>"
            "The spell has a range of 12 inch and affects a single model within range. The target must re-roll any successful armour saves and to hit rolls during the Skaven hand-to-hand phase and his own next shooting and hand-to-hand combat phases."
        ),
    )

    # Added Broheim High Elven Magic
    add_magicref(
        source = "Broheim", 
